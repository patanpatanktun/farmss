    ...
    <div className="bg-slate-100 text-gray-900 min-h-screen flex flex-col justify-between font-sans antialiased [-webkit-font-smoothing:antialiased]">
        ...
        <div className="max-w-[1360px] mx-auto px-10 py-4 flex items-center justify-between">
          <div className="flex items-center gap-10">
            ...
            <nav className="flex items-center gap-8 font-bold text-base text-gray-800">
              ...
              <Link to="/checkmms" className="text-emerald-700 border-b-2 border-emerald-700 py-1 transition">발송 내역</Link>
            </nav>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-[1100px] mx-auto px-6 py-10 w-full flex-1 space-y-8">
        ...
        <div className="mb-2 px-2">
          ...
          <p className="text-gray-700 font-bold text-base">지금까지의 총 발송 MMS 문자 내역을 확인할 수 있습니다.</p>
        </div>

        {/* 상단 요약 통계 카드 영역 */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {/* 카드 1 */}
          <div className="bg-white rounded-3xl border border-gray-200 p-6 shadow-md space-y-2">
            <span className="text-xs font-black text-gray-500 block">총 발송 건수</span>
          ...
          {/* 카드 2 */}
          <div className="bg-white rounded-3xl border border-gray-200 p-6 shadow-md space-y-2">
            <span className="text-xs font-black text-gray-500 block">총 수신자 수</span>
            <div className="flex items-baseline gap-2">
          ...
          {/* 카드 3 */}
          <div className="bg-white rounded-3xl border border-gray-200 p-6 shadow-md space-y-2">
            <span className="text-xs font-black text-gray-500 block">최다 수신 그룹</span>
            <div className="flex items-baseline gap-2">
              <span className="text-2xl font-black text-emerald-700 tracking-tight">전체 농가</span>
            </div>
          </div>
          {/* 카드 4 */}
          <div className="bg-white rounded-3xl border border-gray-200 p-6 shadow-md space-y-2">
            <span className="text-xs font-black text-gray-500 block">총 발송 금액</span>
            <div className="flex items-baseline gap-2">
              <span className="text-2xl font-black text-emerald-700 tracking-tight">65,800원</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-3xl border border-gray-200 shadow-md overflow-hidden">
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b border-gray-200 text-gray-600 text-sm font-black bg-slate-50/80">
              ...
              <tbody className="divide-y divide-gray-100 text-sm font-bold text-gray-800">
                ...
                <tr className="hover:bg-slate-50 transition">
                  <td className="py-5 px-6 font-black text-gray-900">유기질 비료 20kg 특가 안내</td>
                  <td className="py-5 px-6 text-gray-600 font-bold">2026-07-28 09:00</td>
                  <td className="py-5 px-6 font-black text-emerald-800">전체</td>
                  <td className="py-5 px-6 text-gray-900 font-black">24명</td>
                  <td className="py-5 px-6 text-center">
                    <button type="button" className="px-4 py-2 border-2 border-gray-200 hover:border-emerald-700 hover:bg-emerald-50 text-gray-800 rounded-xl text-xs font-black transition shadow-sm">
                      상세보기
                    </button>
                  </td>
                </tr>
                {/* 행 2 */}
                <tr className="hover:bg-slate-50 transition">
                  <td className="py-5 px-6 font-black text-gray-900">친환경 농약 신제품 출시 안내</td>
                  <td className="py-5 px-6 text-gray-600 font-bold">2026-07-15 10:30</td>
                  <td className="py-5 px-6 font-black text-emerald-800">과수 농가, 채소 농가</td>
                  <td className="py-5 px-6 text-gray-900 font-black">18명</td>
                  <td className="py-5 px-6 text-center">
                    <button type="button" className="px-4 py-2 border-2 border-gray-200 hover:border-emerald-700 hover:bg-emerald-50 text-gray-800 rounded-xl text-xs font-black transition shadow-sm">
                      상세보기
                    </button>
                ...
                {/* 행 3 */}
                <tr className="hover:bg-slate-50 transition">
                  <td className="py-5 px-6 font-black text-gray-900">여름 농자재 특별 할인 이벤트</td>
                  <td className="py-5 px-6 text-gray-600 font-bold">2026-07-01 08:00</td>
                  <td className="py-5 px-6 font-black text-emerald-800">전체</td>
                  <td className="py-5 px-6 text-gray-900 font-black">24명</td>
                  <td className="py-5 px-6 text-center">
                    <button type="button" className="px-4 py-2 border-2 border-gray-200 hover:border-emerald-700 hover:bg-emerald-50 text-gray-800 rounded-xl text-xs font-black transition shadow-sm">
                ...
                {/* 행 4 */}
                <tr className="hover:bg-slate-50 transition">
                  <td className="py-5 px-6 font-black text-gray-900">과수 농가 전용 비료 프로모션</td>
                  <td className="py-5 px-6 text-gray-600 font-bold">2026-06-20 09:30</td>
                  <td className="py-5 px-6 font-black text-emerald-800">과수 농가</td>
                  <td className="py-5 px-6 text-gray-900 font-black">12명</td>
                  <td className="py-5 px-6 text-center">
                    <button type="button" className="px-4 py-2 border-2 border-gray-200 hover:border-emerald-700 hover:bg-emerald-50 text-gray-800 rounded-xl text-xs font-black transition shadow-sm">
                      상세보기
                    </button>
                ...
                {/* 행 5 */}
                <tr className="hover:bg-slate-50 transition">
                  <td className="py-5 px-6 font-black text-gray-900">모내기 시즌 특가 비료 안내</td>
                  <td className="py-5 px-6 text-gray-600 font-bold">2026-05-10 07:00</td>
                  <td className="py-5 px-6 font-black text-emerald-800">전남 광주</td>
                  <td className="py-5 px-6 text-gray-900 font-black">15명</td>
                  <td className="py-5 px-6 text-center">
                    <button type="button" className="px-4 py-2 border-2 border-gray-200 hover:border-emerald-700 hover:bg-emerald-50 text-gray-800 rounded-xl text-xs font-black transition shadow-sm">
                      상세보기
                    </button>
