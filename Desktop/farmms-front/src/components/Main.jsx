  ...
  return (
    <div className="bg-slate-100 text-gray-900 min-h-screen flex flex-col justify-between font-sans antialiased [-webkit-font-smoothing:antialiased]">
        ...
        <div className="max-w-[1360px] mx-auto px-10 py-4 flex items-center justify-between">
          <div className="flex items-center gap-10">
            ...
            <nav className="flex items-center gap-8 font-bold text-base text-gray-700">
              <Link to="/main" className="text-emerald-800 border-b-2 border-emerald-800 py-1 transition">홈</Link>
      ...
      <main className="max-w-[1360px] mx-auto px-10 py-10 w-full flex-1 space-y-8">
        ...
        {/* Hero Section */}
        <div className="bg-white rounded-3xl p-8 lg:p-12 border border-gray-200 shadow-sm grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
          ...
          <div className="lg:col-span-2 space-y-5">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black text-gray-900 leading-tight tracking-tight">
              내 농자재 홍보,<br />
              <span className="text-emerald-800">이제 쉽고 빠르게 하세요!</span>
            </h1>
            <p className="text-gray-600 text-lg font-medium pt-2 tracking-tight">
              AI 홍보 이미지 생성부터 문자 발송까지 한 번에 해결해 드립니다.
            </p>
          </div>

          {/* Right Preview Box */}
          <div className="bg-[#eaf2ec] p-6 rounded-3xl border border-emerald-100 flex flex-col items-center justify-center relative shadow-inner">
            <p className="text-xs font-bold text-gray-600 mb-3">📱 고객 수신 문자 예시</p>
            <div className="w-56 bg-white rounded-2xl p-4 shadow-md border border-gray-200 text-xs space-y-3">
              <div className="bg-emerald-800 text-white p-3 rounded-xl text-center font-bold text-sm">
                🌾 유기질비료 특별할인!
              </div>
              <div className="bg-gray-50 p-2.5 rounded-lg text-gray-700 leading-relaxed text-[11px] font-medium">
                <strong>[FarMMS 홍보안내]</strong><br />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          {/* Step 1 Card */}
          <div className="bg-white p-8 rounded-3xl border border-gray-200 shadow-sm hover:shadow-md transition-all flex flex-col justify-between space-y-8">
            <div>
            ...
            <Link to="/contact" className="text-emerald-800 font-extrabold text-lg hover:underline flex items-center space-x-2 pt-2">
              <span>바로가기</span>
              <span>→</span>
            </Link>
          </div>
          ...
          <div className="bg-white p-8 rounded-3xl border border-gray-200 shadow-sm hover:shadow-md transition-all flex flex-col justify-between space-y-8">
            ...
            <Link to="/createimage" className="text-emerald-800 font-extrabold text-lg hover:underline flex items-center space-x-2 pt-2">
              <span>바로가기</span>
              <span>→</span>
            </Link>
          </div>
          ...
          <div className="bg-white p-8 rounded-3xl border border-gray-200 shadow-sm hover:shadow-md transition-all flex flex-col justify-between space-y-8">
            ...
            <Link to="/sendmms" className="text-emerald-800 font-extrabold text-lg hover:underline flex items-center space-x-2 pt-2">
              <span>바로가기</span>
              <span>→</span>
            </Link>
          </div>
        ...
        <div className="bg-white rounded-3xl p-8 lg:p-10 border border-gray-200 shadow-sm flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            <h2 className="text-2xl font-black text-gray-900 tracking-tight">최근 발송 요약 현황</h2>
            <p className="text-gray-500 font-medium text-sm mt-1">실시간 서비스 이용 데이터입니다.</p>
          </div>

          <div className="grid grid-cols-3 gap-8 text-center md:text-right w-full md:w-auto">
            <div className="border-r border-gray-200 pr-8">
              <p className="text-sm font-bold text-gray-400">전체 연락처</p>
              <p className="text-3xl font-black text-gray-900 mt-1">24<span className="text-lg font-bold ml-0.5">명</span></p>
            </div>
            <div className="border-r border-gray-200 pr-8">
              <p className="text-sm font-bold text-gray-400">이번 달 발송</p>
              <p className="text-3xl font-black text-gray-900 mt-1">56<span className="text-lg font-bold ml-0.5">건</span></p>
            </div>
            <div>
              <p className="text-sm font-bold text-gray-400">최다 수신 그룹</p>
              <p className="text-3xl font-black text-emerald-800 mt-1">전체</p>
            </div>
          </div>
        </div>
      ...
      <footer className="w-full bg-white border-t border-gray-200 py-6 px-10 text-center text-gray-400 text-xs mt-12">
        <div className="max-w-[1360px] mx-auto flex flex-col md:flex-row justify-between items-center space-y-2 md:space-y-0">
          <p className="font-bold text-gray-600 text-sm">FarMMS - 농가 통합 MMS 발송 시스템</p>
