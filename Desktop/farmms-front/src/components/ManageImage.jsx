  ...
  return (
    <div className="bg-slate-100 text-gray-900 min-h-screen flex flex-col justify-between font-sans antialiased [-webkit-font-smoothing:antialiased]">
        ...
        <div className="max-w-[1360px] mx-auto px-10 py-4 flex items-center justify-between">
          <div className="flex items-center gap-10">
            ...
            <nav className="flex items-center gap-8 font-bold text-base text-gray-700">
              ...
              <Link to="/manageimage" className="text-emerald-800 border-b-2 border-emerald-800 py-1 transition">이미지 관리</Link>
      ...
      <main className="max-w-[1360px] mx-auto px-10 py-10 w-full flex-1 space-y-8">
        ...
        {/* 페이지 타이틀 & 설명 영역 */}
        <div className="bg-white rounded-3xl p-8 border border-gray-200 shadow-sm space-y-2">
          <h1 className="text-3xl font-black text-gray-900 tracking-tight">이미지 관리</h1>
          <p className="text-gray-600 font-medium text-base">생성된 홍보 이미지를 저장하고 관리하세요. 총 <span className="text-emerald-800 font-black">6개</span></p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            {/* Card 1 */}
            <div className="bg-white rounded-3xl border border-gray-200 shadow-sm overflow-hidden flex flex-col justify-between p-8 space-y-5">
                <div className="text-sm font-bold text-gray-400">2026.07.28 생성</div>
                ...
                <div className="font-extrabold text-gray-900 text-center text-xl tracking-tight">여름 농자재 특별 할인</div>
                <div className="grid grid-cols-3 gap-3 pt-2">
                    <button type="button" className="py-3 bg-emerald-800 hover:bg-emerald-900 text-white font-bold text-sm rounded-2xl transition-colors shadow-sm">저장하기</button>
                    <button type="button" className="py-3 bg-gray-100 hover:bg-gray-200 text-gray-700 font-bold text-sm rounded-2xl transition-colors">수정하기</button>
                    <Link to="/sendmms" className="py-3 bg-gray-100 hover:bg-gray-200 text-gray-700 font-bold text-sm rounded-2xl transition-colors text-center flex items-center justify-center">MMS 발송</Link>
                </div>
            </div>

            {/* Card 2 */}
            <div className="bg-white rounded-3xl border border-gray-200 shadow-sm overflow-hidden flex flex-col justify-between p-8 space-y-5">
                <div className="text-sm font-bold text-gray-400">2026.07.20 생성</div>
                <div className="bg-emerald-50/50 border border-emerald-100 rounded-2xl p-4 flex justify-center">
                    <div className="w-full aspect-[4/5] bg-gray-50 rounded-xl border border-dashed border-gray-300 flex flex-col items-center justify-center text-gray-400 text-base font-medium">
                        <span>이미지 준비중</span>
                    </div>
                </div>
                <div className="font-extrabold text-gray-900 text-center text-xl tracking-tight">과수 농가 전용 비료</div>
                <div className="grid grid-cols-3 gap-3 pt-2">
                    <button type="button" className="py-3 bg-emerald-800 hover:bg-emerald-900 text-white font-bold text-sm rounded-2xl transition-colors shadow-sm">저장하기</button>
                    <button type="button" className="py-3 bg-gray-100 hover:bg-gray-200 text-gray-700 font-bold text-sm rounded-2xl transition-colors">수정하기</button>
                    <Link to="/sendmms" className="py-3 bg-gray-100 hover:bg-gray-200 text-gray-700 font-bold text-sm rounded-2xl transition-colors text-center flex items-center justify-center">MMS 발송</Link>
            ...
            {/* Card 3 */}
            <div className="bg-white rounded-3xl border border-gray-200 shadow-sm overflow-hidden flex flex-col justify-between p-8 space-y-5">
                <div className="text-sm font-bold text-gray-400">2026.07.10 생성</div>
                <div className="bg-emerald-50/50 border border-emerald-100 rounded-2xl p-4 flex justify-center">
                    <div className="w-full aspect-[4/5] bg-gray-50 rounded-xl border border-dashed border-gray-300 flex flex-col items-center justify-center text-gray-400 text-base font-medium">
                        <span>이미지 준비중</span>
                    </div>
                </div>
                <div className="font-extrabold text-gray-900 text-center text-xl tracking-tight">토양개량제 무상지원 안내</div>
                <div className="grid grid-cols-3 gap-3 pt-2">
                    <button type="button" className="py-3 bg-emerald-800 hover:bg-emerald-900 text-white font-bold text-sm rounded-2xl transition-colors shadow-sm">저장하기</button>
                    <button type="button" className="py-3 bg-gray-100 hover:bg-gray-200 text-gray-700 font-bold text-sm rounded-2xl transition-colors">수정하기</button>
                    <Link to="/sendmms" className="py-3 bg-gray-100 hover:bg-gray-200 text-gray-700 font-bold text-sm rounded-2xl transition-colors text-center flex items-center justify-center">MMS 발송</Link>
            ...
            {/* Card 4 */}
            <div className="bg-white rounded-3xl border border-gray-200 shadow-sm overflow-hidden flex flex-col justify-between p-8 space-y-5">
                <div className="text-sm font-bold text-gray-400">2026.07.01 생성</div>
                <div className="bg-emerald-50/50 border border-emerald-100 rounded-2xl p-4 flex justify-center">
                    <div className="w-full aspect-[4/5] bg-gray-50 rounded-xl border border-dashed border-gray-300 flex flex-col items-center justify-center text-gray-400 text-base font-medium">
                        <span>이미지 준비중</span>
                    </div>
                </div>
                <div className="font-extrabold text-gray-900 text-center text-xl tracking-tight">모내기 시즌 비료 특가</div>
                <div className="grid grid-cols-3 gap-3 pt-2">
                    <button type="button" className="py-3 bg-emerald-800 hover:bg-emerald-900 text-white font-bold text-sm rounded-2xl transition-colors shadow-sm">저장하기</button>
                    <button type="button" className="py-3 bg-gray-100 hover:bg-gray-200 text-gray-700 font-bold text-sm rounded-2xl transition-colors">수정하기</button>
                    <Link to="/sendmms" className="py-3 bg-gray-100 hover:bg-gray-200 text-gray-700 font-bold text-sm rounded-2xl transition-colors text-center flex items-center justify-center">MMS 발송</Link>
            ...
            {/* Card 5 */}
            <div className="bg-white rounded-3xl border border-gray-200 shadow-sm overflow-hidden flex flex-col justify-between p-8 space-y-5">
                <div className="text-sm font-bold text-gray-400">2026.06.25 생성</div>
                <div className="bg-emerald-50/50 border border-emerald-100 rounded-2xl p-4 flex justify-center">
                    <div className="w-full aspect-[4/5] bg-gray-50 rounded-xl border border-dashed border-gray-300 flex flex-col items-center justify-center text-gray-400 text-base font-medium">
                        <span>이미지 준비중</span>
                    </div>
                </div>
                <div className="font-extrabold text-gray-900 text-center text-xl tracking-tight">친환경 유기농 영양제</div>
                <div className="grid grid-cols-3 gap-3 pt-2">
                    <button type="button" className="py-3 bg-emerald-800 hover:bg-emerald-900 text-white font-bold text-sm rounded-2xl transition-colors shadow-sm">저장하기</button>
                    <button type="button" className="py-3 bg-gray-100 hover:bg-gray-200 text-gray-700 font-bold text-sm rounded-2xl transition-colors">수정하기</button>
                    <Link to="/sendmms" className="py-3 bg-gray-100 hover:bg-gray-200 text-gray-700 font-bold text-sm rounded-2xl transition-colors text-center flex items-center justify-center">MMS 발송</Link>
            ...
            {/* Card 6 */}
            <div className="bg-white rounded-3xl border border-gray-200 shadow-sm overflow-hidden flex flex-col justify-between p-8 space-y-5">
                <div className="text-sm font-bold text-gray-400">2026.06.15 생성</div>
                <div className="bg-emerald-50/50 border border-emerald-100 rounded-2xl p-4 flex justify-center">
                    <div className="w-full aspect-[4/5] bg-gray-50 rounded-xl border border-dashed border-gray-300 flex flex-col items-center justify-center text-gray-400 text-base font-medium">
                        <span>이미지 준비중</span>
                    </div>
                </div>
                <div className="font-extrabold text-gray-900 text-center text-xl tracking-tight">고추 벼 병해충 방제 안내</div>
                <div className="grid grid-cols-3 gap-3 pt-2">
                    <button type="button" className="py-3 bg-emerald-800 hover:bg-emerald-900 text-white font-bold text-sm rounded-2xl transition-colors shadow-sm">저장하기</button>
                    <button type="button" className="py-3 bg-gray-100 hover:bg-gray-200 text-gray-700 font-bold text-sm rounded-2xl transition-colors">수정하기</button>
                    <Link to="/sendmms" className="py-3 bg-gray-100 hover:bg-gray-200 text-gray-700 font-bold text-sm rounded-2xl transition-colors text-center flex items-center justify-center">MMS 발송</Link>
